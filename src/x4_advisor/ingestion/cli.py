...
def main() -> None:
    ...
    try:
        ...
        print("--------------------------------------------------")
        print(f"Factions Extracted   : {len(factions)}")
        print(f"Wares Extracted      : {len(wares)}")
        print(f"Sectors Extracted    : {len(sectors)}")
        print(f"Sector Yields        : {len(sector_resources)}")
        print(f"Ships Extracted      : {len(ships)}")
